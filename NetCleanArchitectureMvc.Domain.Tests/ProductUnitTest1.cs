    ...
    public class ProductUnitTest1
    {
        ...
        public void CreateProduct_WithValidParameters_ResultObjectValidState()
        {
            Action action = () => new Product(1, "Product Name", "Product Description", 9.99m,
                99, "product image");
            action.Should()
                .NotThrow<NetCleanArchitectureMvc.Domain.Validation.DomainExceptionValidation>();
        }
        ...
        public void CreateProduct_NegativeIdValue_DomainExceptionInvalidId()
        {
            ...
            action.Should().Throw<NetCleanArchitectureMvc.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Id Invalido, Id esta menor que zero");
        }
        ...
        public void CreateProduct_ShortNameValue_DomainExceptionShortName()
        {
            Action action = () => new Product(1, "Pr", "Product Description", 9.99m, 99,
                "product image");
            action.Should().Throw<NetCleanArchitectureMvc.Domain.Validation.DomainExceptionValidation>()
                 .WithMessage("Preencha o Nome com mais de 3 caracteres");
        }
        ...
        public void CreateProduct_LongImageName_DomainExceptionLongImageName()
        {
            ...
            action.Should()
                .Throw<NetCleanArchitectureMvc.Domain.Validation.DomainExceptionValidation>()
                 .WithMessage("Nome imagem não pode ter mais que 250 caracteres");
        }
